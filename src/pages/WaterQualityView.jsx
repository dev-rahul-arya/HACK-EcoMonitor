...
export default function WaterQualityView() {
    ...
    const metrics = [
        { label: 'pH Level', value: currentData.water.ph, icon: <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z" /> },
        { label: 'Dissolved Oxygen', value: currentData.water.dissolvedOxygen, unit: 'mg/L', icon: <><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="4" /></> },
        { label: 'Temperature', value: currentData.water.temperature, unit: '°C', icon: <path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z" /> },
        { label: 'Turbidity', value: currentData.water.turbidity, unit: 'NTU', icon: <path d="M22 12h-4l-3 9L9 3l-3 9H2" /> },
        { label: 'TDS', value: currentData.water.tds, unit: 'ppm', icon: <><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M7 7h.01M17 7h.01M7 17h.01M17 17h.01" /></> },
        { label: 'Conductivity', value: currentData.water.conductivity, unit: 'μS/cm', icon: <><circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" /></> },
    ];
        ...
        <section className="view active" id="view-water-quality">
            <div className="view-content">
                ...
                <div className="chart-card full-width">
                    <div className="card-header"><h3>Water Quality Trends</h3></div>
